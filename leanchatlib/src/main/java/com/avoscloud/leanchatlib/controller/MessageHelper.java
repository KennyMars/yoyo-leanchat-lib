...
import com.avoscloud.leanchatlib.model.MsgType;
...
public class MessageHelper {
    ...
    public static MsgAction getMsgAction(JSONObject json) {
        try {
            String action = json.getJSONObject("attr").getString("action");
            return MsgAction.valueOf(action);
        } catch (Exception e) {
            return MsgAction.msg;
        }
    }

    public static MsgType getMsgType(JSONObject json) {
        try {
    ...
    public static boolean fromMe(AVIMMessage msg) {
