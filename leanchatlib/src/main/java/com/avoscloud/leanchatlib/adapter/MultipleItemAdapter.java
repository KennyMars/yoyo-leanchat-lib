...
import com.avoscloud.leanchatlib.viewholder.ChatItemTextYoyoXiaomiHolder;
...
public class MultipleItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final int ITEM_LEFT_TEXT_YOYOXIAOMI = 105;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case ITEM_LEFT_TEXT_YOYOXIAOMI:
                return new ChatItemTextYoyoXiaomiHolder(parent.getContext(), parent, true);
    ...
    public int getItemViewType(int position) {
        ...
        if (null != message /*&& message instanceof AVIMTypedMessage*/) {
            ...
            boolean isMe = MessageHelper.fromMe(message);
            ...
            switch (MessageHelper.getMsgType(json)) {
                case text:
                    if(MessageHelper.getMsgAction(json)== MsgAction.system) {
                        return isMe ? ITEM_RIGHT_TEXT : ITEM_LEFT_TEXT_YOYOXIAOMI;
                    }else {
