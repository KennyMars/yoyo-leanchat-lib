...
public class PhotoUtils {
    public static DisplayImageOptions avatarImageOptions = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.drawable.chat_default_image_bg)
            .showImageForEmptyUri(R.drawable.chat_default_image_bg)
            .showImageOnFail(R.drawable.chat_default_image_bg)
            .cacheInMemory(true)
            .cacheOnDisc(true)
